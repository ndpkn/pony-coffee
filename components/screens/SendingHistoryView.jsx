...
const SeendingHistoryView = ({notifications, error, loading}) => {
            ...
            <div className={styles.singleNotification} key={i}>
                <div className={styles.singleNotification_topBlock}>
                    <div className={styles.singleNotification_topBlock_item}>
                        <p className={styles.singleNotification_p}>Дата создания:</p>
                        <p>{date}</p>
                        <p>{time}</p>
                    </div>
                    <div className={styles.singleNotification_topBlock_item}>
                        <p className={styles.singleNotification_p}>Вид рассылки:</p>
    ...
    return (
        ...
        <PageHeader text='История рассылки'/>
            ...
            {spinner}
            {content}
        <MainButtonLink buttonName='Вернуться назад' action='primary' href='/sending'/>
    </div>
    )
}
