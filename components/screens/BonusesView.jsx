...
const BonusesView = ({error, loading, allUsers, writeOff, searchTerm, setSearchTerm, handleCloseDialogAdd, openDialogAdd, bonusCount, addBonuses, id, sendBonuses, handleCloseDialogRemove, openDialogRemove, removeBonuses, filteredUsers, setBonusCount, handleOpenDialogAdd, handleOpenDialogRemove, messages}) => {
